...
<tbody>
    <tr v-for="pro in products">
        ...
        <td>
            ...
            <button type="button" @click="deleteClick(pro.ProductId)"
            class="btn btn-light mr-1">
    ...
    <div class="d-flex flex-row bd-highlight mb-3">
        <div class="p-2 w-50 bd-highlight">
            ...
            <div class="input-group mb-3">
                ...
                <input type="date" class="form-control" v-model="DateOfExpiration">
            </div>
...
methods:{
    ...
    editClick(pro){
        ...
        this.DateOfExpiration=pro.DateOfJoining,
        this.PhotoFileName=pro.PhotoFileName
    },
    createClick(){
