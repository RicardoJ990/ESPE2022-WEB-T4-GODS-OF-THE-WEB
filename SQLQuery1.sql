create database GRUPO_N1_ACTIVIDAD_2_SGBD;

use GRUPO_N1_ACTIVIDAD_2_SGBD;

create table TITULACIONES (
Cod_titulacion int primary key identity,
...
create table GRUPOS (
Cod_grupo int not null identity,
